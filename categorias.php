    ...
    <body>
      <div id="header" class="container"> 
                                  ...
                                  <li><a href="recetas.php">Recetas</a></li>
                                   <li class="dropdown">
                                      ...
                                      <ul class="dropdown-menu limpiar" role="menu">
                                          ...
                                          <li><a class="active1 " href="categorias.html">Carnes blancas</a></li>
        ...
        <div style="background-color: white;">
         <h2 class="container subtitulos img-margin-inicio">Recetas</h2>
...
?>
              <div class="gallery_product col-md-4">
                  <a href="receta.php" onclick="makePage()">
                    <img src="images/da.jpg" class="img-responsive">
                
                        <h4 class="h4-gallery"><?php echo $re['titulo']?><br><?php echo $re['fecha']; ?>
...
?>
         ...
         <div id="footer" class="container"><div class="col-md-9"></div>
            ...
            <form class="container" action="mailto:danny.boteo@gmail.com" method="post" enctype="text/plain"><br><br>
                ...
                <input class="pull-right s-d" type="submit" value="Enviar">
                <input class="pull-right s-d" type="reset" value="Borrar">
